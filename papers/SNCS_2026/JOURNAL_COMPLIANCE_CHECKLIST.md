...
- Springer Nature AI guidance and editorial policies: https://www.springernature.com/gp/policies/editorial-policies
...
| Source files | PASS | Manuscript is LaTeX; journal permits LaTeX for mathematical content. |
| Title page contains title | PASS | `\title` present. |
...
| Structured abstract | PASS | 196 words; includes Purpose, Methods, Results, Conclusion. |
...
| Reference list | PASS | BibTeX contains unique keys; cited keys resolve. DOI/published-version updates made where available. |
...
| Data/materials/code availability | PASS | Repository, public benchmarks, processed artifacts, and raw-provider exclusion are stated. |
| Author contributions | PASS | Single-author contribution statement present. |
...
| Highlights | NOT APPLICABLE | SN Computer Science guidelines checked did not request highlights; a separate optional highlights file is prepared for portal use if requested. |

## Residual Notes

The journal's text-formatting section gives Word-first instructions but explicitly permits LaTeX for mathematical content. The manuscript follows the Springer Nature `sn-jnl` template and includes editable LaTeX source.
