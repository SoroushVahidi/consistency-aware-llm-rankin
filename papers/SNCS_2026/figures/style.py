...
# Single-column text width for the Springer Nature sn-jnl.cls "sn-basic"
# single-column layout: text={31pc,194.25mm} in the class's geometry setup,
# 31pc = 31*12pt = 372pt = 372/72.27in ~= 5.148in. This manuscript
# (papers/SNCS_2026/) does not use the class's "iicol" (two-column) option,
# so every figure is single-column at this width, not ACM's 3.35in.
COL_WIDTH_IN = 5.10
PAGE_WIDTH_IN = 5.10  # sn-jnl.cls single-column layout has no wider option
