...
|----------|-------------|
| [`repo_publication_audit.md`](repo_publication_audit.md) | **Start here** — publication-readiness audit, canonical package, claim support |
| [`canonical_results_inventory.csv`](canonical_results_inventory.csv) | Result packages and experiment families |
| [`claim_support_matrix.csv`](claim_support_matrix.csv) | Claim × evidence classification |
