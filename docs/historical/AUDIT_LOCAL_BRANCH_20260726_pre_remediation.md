> **HISTORICAL ARCHIVE — DO NOT USE AS CURRENT STATUS**
>
> This file is a frozen snapshot of the **pre-remediation** audit performed on
> 2026-07-26 against an uncommitted working tree at `main` /
> `3e02b73666506f3eb894f5df2c531284ea31a60e`.
>
> Findings F-001–F-003 (unsafe `selective_three_way` default; routing safety
> floor; unreachable stop/challenger safeguards) were subsequently **resolved**
> on branch `fix/outcome-f-production-operating-point` beginning at commit
> `361433358b756965ab8ae2459892019f3ba9f4f9`. Process finding F-004 (no
> reviewable commits) was **partially resolved** when that stack was committed
> (six commits ahead of `origin/main` as of 2026-07-26 evening).
>
> For the **current** branch status, read repository-root `AUDIT_LOCAL_BRANCH.md`
> and `REMEDIATION_REPORT.md`. Do not treat the executive verdict
> “NOT PRODUCTION-READY” or the claim that `PolicySelector` defaults to
> `selective_three_way` as describing today’s code.
